...
$isPost1 = in_array($page, ['nav-menus', 'slides', 'settings']);
...
<div class="aside">
    ...
    <!-- 仪表盘 -->
     ...
     <!-- 设置模块 --> 
      <li class="<?php echo $isPost1 ? 'active' : '' ?>">
        <a href="#menu-settings" class="<?php echo $isPost1 ? '':'collapsed' ?>" data-toggle="collapse">
          <i class="fa fa-cogs"></i>设置<i class="fa fa-angle-right"></i>
        </a>
        <ul id="menu-settings" class="collapse <?php echo $isPost1 ? 'in' : '' ?>">
