<?php 
  ...
  isLogin();
   ...
   $allpost=my_query($postsql)[0]["total"];
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="panel panel-default">
            ...
            <ul class="list-group">
              <li class="list-group-item"><strong><?php echo($allpost)?></strong>
              篇文章（<strong><?php echo($dratotal)?></strong>篇草稿）</li>
              <li class="list-group-item"><strong><?php echo($catetotal)?></strong>个分类</li>
              <li class="list-group-item"><strong><?php echo($comtotal)?></strong>
              条评论（<strong><?php echo($heldtotal)?></strong>条待审核）</li>
            </ul>
          </div>
        </div>
